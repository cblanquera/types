...
describe('Hash Store Tests', () => {
  ...
  it('Should set with query string', async () => {
    let store = new HashStore;
    store.withQuery.set('zoo=bar&foo[zoo][0]=foo&foo[zoo][1]=bar&foo[zoo][2]=zoo');
